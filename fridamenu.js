...
const TPlayerSetBombsCount = 

"_ZN10W6NzgawMJy10cd4pwa59xTEI";

Interceptor.attach(Module.findExportByName
      ("libqplay.so", TPlayerSetBombsCount),{
...
const option1 = {
    on() {
        bomb = true;//hook or call
    },
    off() {
      bomb = false;//deatch hook or call
    }
}
...
Java.perform(function () {
    Java.scheduleOnMainThread(function () {
        ...
        menu.createMenuStart("NodeAd", 15, "#FF0000")
        //set menu layout color and size
        menu.createMenuLayout("#000000", 180)
        //set cor bar color
        menu.createMenuBarLayout("#FF0000")
        //name and name color
        menu.createMenuBarTitle("NodeAd Hx", "#000000")
